...
messages using DHCPv6 {{I-D.ietf-dhc-rfc8415bis}} for dynamic provisioning
...
{{I-D.ietf-dhc-rfc8415bis}} do not foresee the possibility to handle legacy DHCPv4,
...
* DHCP Relay Agent:
   ...
   {{RFC2131}} {{RFC2132}}, and DHCPv6 {{I-D.ietf-dhc-rfc8415bis}}.
...
Option Request option as described in {{I-D.ietf-dhc-rfc8415bis}}
before it can use the 4o6 transport.

To maintain interoperability with existing DHCPv6 relays and servers,
the message format is unchanged from {{I-D.ietf-dhc-rfc8415bis}}. The 4o6RA implements
...
DHCPv4 {{RFC2131}} and DHCPv6 {{I-D.ietf-dhc-rfc8415bis}} specifications
